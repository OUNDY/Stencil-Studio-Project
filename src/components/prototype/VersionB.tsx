...
export const VersionB = () => {
  ...
  const results = filterPatterns(selectedMood, selectedSurface);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 p-6 rounded-2xl border border-border bg-card/50">
        <div>
          <p className="text-sm font-sans text-muted-foreground mb-3 tracking-wide uppercase">Mood</p>
        ...
        <div>
          <p className="text-sm font-sans text-muted-foreground mb-3 tracking-wide uppercase">Surface</p>
          <div className="flex flex-wrap gap-2">
            {surfaces.map((s) => (
              <button
                key={s}
