...
const collections = [
  {
    id: "botanical",
    name: "Botanik Serisi",
    description: "Doğanın zarif çizgileri duvarlarınızda",
    image: "🌿",
    itemCount: 24,
    popular: true,
  },
  {
    id: "geometric",
    name: "Geometrik",
    description: "Modern çizgiler, sonsuz kombinasyonlar",
    image: "◇",
    itemCount: 18,
    popular: false,
  },
  {
    id: "mandala",
    name: "Mandala",
    description: "Meditasyonu duvarlarınıza taşıyın",
    image: "✿",
    itemCount: 15,
    popular: true,
  },
  ...
  },
  {
    id: "ethnic",
    name: "Etnik Motifler",
    description: "Geleneksel desenler, modern yorumlar",
    image: "◬",
    itemCount: 20,
    popular: false,
  },
  {
    id: "kids",
    name: "Çocuk Dünyası",
    description: "Küçük hayalperestler için",
    image: "★",
    itemCount: 30,
    popular: true,
  },
