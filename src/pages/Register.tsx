...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // Simulated registration - would integrate with auth provider
    setTimeout(() => {
      setIsLoading(false);
      navigate("/");
    }, 1500);
          ...
          <div className="bg-card rounded-3xl p-8 md:p-10 shadow-organic border border-border">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-muted-foreground">
                Yaratıcı yolculuğunuza bugün başlayın
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                    placeholder="••••••••"
                    required
                  />
                  <button
                  ...
                  >
                    {passwordRequirements.map((req) => (
                      ...
                      >
                        <Check
                          className={`w-3 h-3 ${
                            req.check(password) ? "opacity-100" : "opacity-30"
                          }`}
                        />
                        {req.label}
                      </div>
